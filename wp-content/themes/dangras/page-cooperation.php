...
<header class="master-online">
    <div class="container-fluid">
        <div class="row">
            <div class="header-bg"
                 style="background-image: url(<?php echo get_template_directory_uri(); ?>/img/coop-page/bg-img.png); background-size: cover; min-height: 600px; height: 100vh">
                <?php get_template_part('navigation'); ?>
                <div class="container">
                    <div class="row ">
                        <div class="col-lg-12 col-sm-12 col-xs-6 at">
                            <a href="/">
                            ...
                            <div class="content">
                                <h1>
                                    Зарабатывайте от 30 000 рублей <br>
                                    на наших мероприятиях
                                </h1>
                                <p>Станьте организатором выездных мероприятий в своем городе, <br>
                                    или проводите самостоятельно по нашей авторской методике
...
<section class="other-inf" id="second-scr">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 other-item no-margin" id="left-it">
                <h1>Форматы сотрудничества <br>
                    с нами</h1>
                <p>It is a long established fact that a reader will be distracted by <br>
                    the readable content of a page when looking at its layout. </p>
            </div>

            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 other-item other-it-2">
                <span class="circle">2</span>
                <h3>Lorem ipsun</h3>
                <p>Обучение в вашем <br>
                    городе самостоятельно по моей <br>
                    методики и от моего имени
                </p>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 other-item no-margin other-it-3">
                <span class="circle">3</span>
                <h3>Lorem ipsun</h3>
                <p>Станьте дилером наших <br>
                    инструментов и материалов для <br>
                    ногтевого сервиса в своем городе
                </p>
            </div>
        </div>
</section>
...
<section class="slider-snake"></section>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 content">
                <h1>Станьте представителем нашей <br>
                    продукции в своем городе и зарабатывайте <br>
            ...
            <div class="butn-rep">
                <a href="#" class="butn-content">Стать представителем</a>
            </div>
        ...
        <div class="row">
            <div class="col-12 train" style=" ">
                ...
                <div class="col-12 form-title">
                    <h1>Оставьте заявку и узнайте <br>
