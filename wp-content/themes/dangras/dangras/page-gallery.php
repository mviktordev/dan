...
<?php get_header(); ?>
    ...
    <header class="master online">
        <div class="container-fluid">
            <div class="row">
                <div class="header-bg"
                     style="background-image: url(<?php echo get_template_directory_uri(); ?>/img/gallery/bg.png); background-size: cover; min-height: 600px; height: 100vh">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="content">
                                    <h1>
                                        Идеальный маникюр за 1 час <br>
                                        от 600 рублей
                                    </h1>
                                    <p>Полный комплекс услуг маникюра и педикюра по авторской <br>
                                        технологии Александры Данграс
                                    </p>
                                    <a href="#" class="butn-content">Записаться</a>
                                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 content">
                    <h1>Запишитесь на приём <br>
                        в удобный для вас день</h1>
